      ...
      <div className="mb-4 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-xl text-xs leading-5 text-stone-500">
            Apply or hide candidates derived from approval, rejection, and edit patterns.
          </p>
        </div>
        <button
          type="button"
...
function PolicyBadge({ kind }: { kind: PolicyKind }) {
  const meta = {
    ...
    REQUIRE_DRAFT_REVIEW: ["Keep draft review", "border-sky-400/20 bg-sky-400/10 text-sky-300"],
